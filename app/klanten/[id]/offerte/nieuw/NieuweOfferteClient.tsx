...
export default function NieuweOfferteClient({
  ...
  // Zet komma of punt om naar getal
      ...
      <div className="page-header">
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{
            ...
            <FileText size={20} style={{ color: "var(--accent-hover)" }} />
          </div>
          <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="card" style={{ marginBottom: 20 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            <div className="form-group" style={{ marginBottom: 0 }}>
              <label className="form-label">Geldig (dagen)</label>
              <input
                type="number"
                value={geldigDagen}
                onChange={(e) => setGeldigDagen(Number(e.target.value))}
            ...
            <div className="form-group" style={{ marginBottom: 0 }}>
              ...
              <input
                ...
                placeholder="Bijv. inclusief installatie"
                className="form-input"
              />
            </div>
          </div>
          ...
          <div className="card" style={{ minWidth: 280 }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", paddingTop: 10, borderTop: "1px solid var(--border)" }}>
                ...
                <span style={{ fontWeight: 700, fontSize: "1.1rem", color: "var(--accent-hover)", fontFamily: "var(--font-mono)" }}>
                  {fmt(totaal)}
                </span>
              </div>
            </div>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "flex-end" }}>
          ...
          <button type="submit" className="btn btn-primary" disabled={loading}>
            {loading ? "Opslaan..." : "Offerte opslaan"}
          </button>
        </div>
      </form>
    </div>
